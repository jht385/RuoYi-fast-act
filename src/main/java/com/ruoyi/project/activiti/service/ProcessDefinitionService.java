...
public class ProcessDefinitionService {
     ...
     * @return
     */
    public Page<com.ruoyi.project.activiti.domain.ProcessDefinition> listProcessDefinition(com.ruoyi.project.activiti.domain.ProcessDefinition processDefinition) {
        PageDomain pageDomain = TableSupport.buildPageRequest();
        Integer pageNum = pageDomain.getPageNum();
        Integer pageSize = pageDomain.getPageSize();

        Page<com.ruoyi.project.activiti.domain.ProcessDefinition> list = new Page<>();
        ...
        for (ProcessDefinition definition: processDefinitionList) {
            ...
            com.ruoyi.project.activiti.domain.ProcessDefinition entity = new com.ruoyi.project.activiti.domain.ProcessDefinition();
